export default function Services() {
 ...
 return (
 <section id="services" className="w-full py-24 md:py-32 px-6 bg-white overflow-hidden">
 <div className="max-w-4xl mx-auto">
 
 <div className="text-center mb-20 animate-on-scroll is-visible">
 <p className="text-sm font-semibold text-brand-dark uppercase tracking-widest mb-3">What I Offer</p>
 <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-brand-dark mb-6">Strategic engineering</h2>
 ...
 <div className="absolute left-[39px] md:left-1/2 md:-translate-x-1/2 top-4 bottom-4 w-[1px] bg-gray-200 hidden sm:block z-0"></div>
 ...
 <div className={`inline-flex items-center justify-center w-12 h-12 rounded-xl bg-brand-surface border border-gray-100 mb-6 ${isEven ? 'sm:ml-auto' : ''}`}>
 <img src={service.icon} alt="" className="w-6 h-6 opacity-70" />
 </div>
 ...
 <div className={`shrink-0 w-20 h-20 rounded-full bg-white border border-gray-200 shadow-sm flex items-center justify-center sm:order-2 z-10 self-start sm:self-auto`}>
